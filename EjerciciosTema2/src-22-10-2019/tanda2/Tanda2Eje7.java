...
public class Tanda2Eje7 {
	...
	static void ciComp(int ci, int comp) {
		if (ci < comp) {
			System.out.println("El coeficiente intelectual es inferior a la media");
		}
		else if(ci == comp) {
			System.out.println("El coeficiente intelectual es igual a la media");
		}
		else {
			System.out.println("El coeficiente intelectual es superior a la media");
		}	
	}
	
	public static void main(String[] args) {
		final int N = 5, MM = 102, MS = 106, HM = 101, HS = 105;
